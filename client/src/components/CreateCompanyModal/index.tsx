...
export const CreateCompanyModal: React.FunctionComponent<CreateCompanyModalProps> =
  ({ isOpen, toggle }) => {
    ...
    const [companyHeadquartersId, setCompanyHeadquartersId] =
      React.useState<number>();
    const [createCompanyCity, setCreateCompanyCity] =
      React.useState<string>('Rochester');
    const [createCompanyState, setCreateCompanyState] =
      React.useState<string>('NY');
    const [createCompanyCountry, setCreateCompanyCountry] =
