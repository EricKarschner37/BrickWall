...
export const CreateOfferModal: React.FunctionComponent<CreateOfferModalProps> =
  ({ isOpen, toggle, company }) => {
    ...
    const [offerLocationCity, setOfferLocationCity] =
      React.useState<string>('Rochester');
    const [offerLocationState, setOfferLocationState] =
      React.useState<string>('NY');
    const [offerLocationCountry, setOfferLocationCountry] =
